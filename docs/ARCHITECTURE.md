...
- **Nothing about when or what predicts the rating.** Kruskal-Wallis on first viewings with a rating: month p=<!--stat:p_month-->0.01<!--/stat-->, weekday p=<!--stat:p_weekday-->0.08<!--/stat-->, genre p=<!--stat:p_genre-->0.00<!--/stat-->. What changes is volume, not scores. Generated by [`scripts/compute_story_stats.py`](../scripts/compute_story_stats.py).
