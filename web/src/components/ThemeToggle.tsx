  ...
  return (
    ...
    >
      {/* The destination's page ground, as a small filled circle: the label names
          where the toggle goes and this shows it. A swatch and not the whole pill,
          because a dark-filled pill in light mode would be the highest-contrast
          thing on the page, and UI state on this branch was deliberately moved off
          the accent so chrome stops competing with the data. Decorative — the
          label and aria-label already say everything a reader needs. */}
      <span
        aria-hidden="true"
